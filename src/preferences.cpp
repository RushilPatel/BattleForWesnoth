/* $Id: preferences.cpp 55984 2013-01-01 09:34:55Z mordante $ */
/*
...
void save_turbo_speed(const double speed)
{
	...
	hotkey::game_speed_label(false , false);
}
//returns width of the sceen
double xwindow_size()
{
	return prefs["xwindowsize"].to_double();
}
//returns height of the screen
double ywindow_size()
{
	return prefs["ywindowsize"].to_double();
}
